...
<td style="text-align: center"><?= $bdy->nama_event; ?></td>
<td style="text-align: center"><?= $bdy->kegiatan; ?></td>
<td style="text-align: center"><img src="<?= base_url('uploads/event/') . $bdy->foto; ?> " alt="" height="80"></td>
</tr>
<?php endforeach; ?>
</tbody>
