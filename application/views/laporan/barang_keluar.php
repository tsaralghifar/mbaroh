...
<section class="content-header">
    <h1>Data Inventaris
        <small>Rekap Barang Keluar</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i></a></li>
        <li>Rekap Barang Keluar</li>
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="pull-right">
                            <form action="<?= base_url('laporan/generate_barang_keluar'); ?>" method="post">
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-header">
                                ...
                                <form action="<?= base_url('laporan/generate_barangkeluar_periode/'); ?>" method="post">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="text-center" width="160px">
                                            <form action="<?= base_url('laporan/barang_keluar_print/'); ?>" method="post">
