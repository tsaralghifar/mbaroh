...
<td style="text-align: center"><?= $bdy->nama_karyawan; ?></td>
<td style="text-align: center"><?= $bdy->alamat; ?></td>
<td style="text-align: center"><img src="<?= base_url('uploads/karyawan/') . $bdy->foto; ?> " alt="" height="80"></td>
</tr>
<?php endforeach; ?>
</tbody>
