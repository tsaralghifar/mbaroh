...
<section class="content-header">
    <h1>Data Inventaris
        <small>Rekap Barang Masuk</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i></a></li>
        <li>Rekap Barang Masuk</li>
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="pull-right">
                            <form action="<?= base_url('laporan/generate_barang_masuk'); ?>" method="post">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="text-center" width="160px">
                                            <form action="<?= base_url('laporan/barang_masuk_print/'); ?>" method="post">
