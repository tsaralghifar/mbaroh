...
<td style="text-align: center"><?= $bdy->nama_barang; ?></td>
<td style="text-align: center"><?= $bdy->tipe_barang; ?></td>
<td style="text-align: center"><?= $bdy->status; ?></td>
<td style="text-align: center"><img src="<?= base_url('uploads/fasilitas/') . $bdy->foto_barang; ?> " alt="" height="80"></td>
</tr>
<?php endforeach; ?>
</tbody>
